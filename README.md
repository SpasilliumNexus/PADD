...
```bash
cd ~
wget -N https://raw.githubusercontent.com/SpasilliumNexus/PADD/master/padd.sh
```
...
## FAQ
*Answers to frequently asked questions can be found in the original repo’s [wiki](https://github.com/jpmck/PADD/wiki/FAQ).*
